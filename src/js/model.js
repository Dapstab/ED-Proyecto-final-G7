...
import { PQ } from "./dataStructures/priorityQueue.js";
...
export const getSearchResultPage = function (page = state.search.page) {
  ...
  console.log(state.search.results, "desde getSearch");
...
export const getOrder = function (id) {
  const recipe = recipesLl.find(id);
  console.log(recipe.value);
  PQ.enqueue(recipe.value, recipe.value.cookingTime);
